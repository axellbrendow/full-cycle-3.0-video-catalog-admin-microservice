...
public class CategoryJpaRepositoryTest {
    ...
    public void givenAnInvalidNullName_whenCallsSave_shouldReturnError() {
        ...
        final var expectedErrorMessage = "not-null property references a null or transient value : com.axell.fullcycle.video.catalog.admin.infrastructure.category.persistence.CategoryJpaEntity.name";
    ...
    public void givenAnInvalidNullCreatedAt_whenCallsSave_shouldReturnError() {
        ...
        final var expectedErrorMessage = "not-null property references a null or transient value : com.axell.fullcycle.video.catalog.admin.infrastructure.category.persistence.CategoryJpaEntity.createdAt";
    ...
    public void givenAnInvalidNullUpdatedAt_whenCallsSave_shouldReturnError() {
        ...
        final var expectedErrorMessage = "not-null property references a null or transient value : com.axell.fullcycle.video.catalog.admin.infrastructure.category.persistence.CategoryJpaEntity.updatedAt";
